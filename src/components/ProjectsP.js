			    	...
			    	<div className="proejcts">
			    		<ul className="pro">
			    			<li className="mob">
					    		...
					    		<div className="mobile">
						    		...
						    		<p>Expo</p>
						    		<h6>
						    			<a target="_blank" href="hhttps://expo.io/@shinedark/timerWork" rel="noopener noreferrer">
				            			</a>
				            		</h6>
				            		<h3>Poke Search</h3>
						    		...
						    		<p>Expo</p>
						    		<h6>
						    			<a target="_blank" href="https://expo.io/@shinedark/pokesearch" rel="noopener noreferrer">
				            			</a>
				            		</h6>
					    		</div>
					    	</li>
					    <li className="wb">
				    		...
				    		<div className="web">
					    		...
					    		<h6>
					    			<a target="_blank" href="https://shinedarkmusic.com/" rel="noopener noreferrer">
			            			</a>
			            		</h6>
			            		<h3>Sports</h3>
					    		...
					    		<p>React exercie</p>
					    		<h6>
					    			<a target="_blank" href="https://sports-87601.firebaseapp.com/" rel="noopener noreferrer">
			            			</a>
			            		</h6>
			            		<h3>Alog</h3>
					    		...
					    		<p>Node App</p>
					    		<h6>
					    			<a target="_blank" href="https://alog2.herokuapp.com/" rel="noopener noreferrer">
			            			</a>
			            		</h6>
				    		</div>
				    	</li>
				    	<li className="ot">
				    		...
				    		<div className="other">
					    		...
					    		<p>Experiment</p>
					    		<h6>
					    			<a target="_blank" href="https://shinedark.github.io/drones/" rel="noopener noreferrer">
			            			</a>
			            		</h6>
			            		<h3>C-am Sampler</h3>
					    		...
					    		<p>Css Experiment</p>
					    		<h6>
					    			<a target="_blank" href="https://shinedark.github.io/vid/" rel="noopener noreferrer">
			            			</a>
			            		</h6>
				    		</div>
				    	</li>
